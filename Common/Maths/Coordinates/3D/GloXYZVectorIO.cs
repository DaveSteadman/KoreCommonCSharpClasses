...
public static class GloXYZVectorIO
{
    // Usage: string str = GloXYVectorIO.ToString(new GloXYZVector(1.0, 2.0, 3.0));
    public static string ToString(GloXYZVector vector)
    {
    ...
    // Usage: GloXYZVector vector = GloXYZVectorIO.FromString("X:1.0, Y:2.0, Z:3.0");
    public static GloXYZVector FromString(string str)
    {
        var parts = str.Split(',');
