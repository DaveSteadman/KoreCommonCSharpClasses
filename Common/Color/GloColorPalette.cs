...
public static class GloColorPalette
{
    ...
    public static readonly Dictionary<string, GloColorRGB> Colors = new Dictionary<string, GloColorRGB>
    {
        ...
        // Secondary and midtone colors (0s, 0.5s, 1s not already covered)
        ...
        { "Gold",        new GloColorRGB(1.00f, 0.84f, 0.00f) },
        { "Silver",      new GloColorRGB(0.75f, 0.75f, 0.75f) },
        { "Bronze",      new GloColorRGB(0.80f, 0.52f, 0.25f) },
        { "Brown",       new GloColorRGB(0.60f, 0.40f, 0.20f) },
        { "Pink",        new GloColorRGB(1.00f, 0.75f, 0.80f) },
        { "Lime",        new GloColorRGB(0.75f, 1.00f, 0.00f) },
        { "Indigo",      new GloColorRGB(0.29f, 0.00f, 0.51f) },
        { "Copper",      new GloColorRGB(0.72f, 0.45f, 0.20f) },
        { "Coral",       new GloColorRGB(1.00f, 0.50f, 0.31f) },
        { "Lavender",    new GloColorRGB(0.90f, 0.90f, 1.00f) },
        { "Peach",       new GloColorRGB(1.00f, 0.85f, 0.70f) },
        { "Mint",        new GloColorRGB(0.70f, 1.00f, 0.70f) },
        ...
        { "MutedSilver", new GloColorRGB(0.6f, 0.6f, 0.6f) },
        { "MutedBronze", new GloColorRGB(0.7f, 0.5f, 0.3f) }
    };
}
