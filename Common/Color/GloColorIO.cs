...
public static class GloColorIO
{
    ...
    // Usage: byte maxByte = GloColorIO.MaxByte;
    // Usage: byte minByte = GloColorIO.MinByte;
    ...
    // Usage: string hexString = GloColorIO.RBGtoHexString(new GloColorRGB(0.5f, 0.2f, 0.8f, 1.0f));
