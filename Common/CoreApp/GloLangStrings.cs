...
public class GloLangStrings
{
    private static GloLangStrings _instance = null!;
    ...
    private GloLangStrings(string filename)
    {
        LoadFile(filename);
    }

    public static GloLangStrings Instance
    {
        get
        {
            lock (_lock)
            {
                if (_instance == null)
                {
                    ...
                    throw new InvalidOperationException("GloLangStrings instance not initialized. Call GloLangStrings.Initialize() first.");
                }
                return _instance;
            }
        }
    ...
    public static void Initialize(string filename)
    {
        ...
        {
            if (_instance != null)
                throw new InvalidOperationException("GloLangStrings has already been initialized.");

            _instance = new GloLangStrings(filename);
        }
    }
